//! `jsmv`'s implementation of JavaScript's `Request` Web API Class.
//!
//! More information:
...
impl Request {
    ...
    pub fn new(
        ...
        // MAVRYK SPECIFIC: Check if URL scheme is "mavryk"
...
impl jsmv_core::Api for RequestApi {
