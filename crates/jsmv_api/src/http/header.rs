//! `jsmv`'s implementation of JavaScript's `Headers` Web API Class.
//!
//! Represents response/request headers, allowing you to query them and take different
//! actions depending on the results in `jsmv` contracts.
//!
...
impl PairIterable for Headers {
    ...
    fn pair_iterable_get(
        ...
        index: usize,
        context: &mut Context<'_>,
    ) -> JsResult<jsmv_core::iterators::PairValue> {
...
impl jsmv_core::Api for HeadersApi {
