//! `jsmv`'s implementation of JavaScript's `console` Web API object.
//!
...
/// `ConsoleApi` implements `jsmv_core::host::Api`, permitting it to be registered
/// as a `jsmv` runtime API.  
...
impl jsmv_core::Api for ConsoleApi {
