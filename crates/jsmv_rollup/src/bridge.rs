...
use mavkit::MavkitClient;
use mavryk_crypto_rs::hash::ContractKt1Hash;

use crate::BootstrapAccount;

const CTEZ_CONTRACT: &str = include_str!("../../../contracts/jsmv_ctez.tz");
const BRIDGE_CONTRACT: &str = include_str!("../../../contracts/jsmv_bridge.tz");
    ...
    I: Iterator<Item = &'a BootstrapAccount>,
{
    ...
    client.originate_contract("jsmv_ctez", operator_address, CTEZ_CONTRACT, &init_storage)
}
