  ...
  try {
    // Constructor 1
    {
      ...
      console.log(
        `Actual: ${oldRequest.headers.get(
          "From",
        )}, Expected: webmaster@example.org`,
      );
    }
    ...
    // Constructor 2
    {
      ...
      const myRequest = new Request(
        "mavryk://flowers.tez/flowers.jpg",
        myOptions,
      );
      console.log(
        `Actual: ${myRequest.headers.get(
          "Content-Type",
        )}, Expected: image/jpeg`,
      );
    ...
    // bodyUsed
    {
      const request = new Request("mavryk://sam.tez/myEndpoint", {
        method: "POST",
        body: "Hello world",
      });
    ...
    // Headers 1
    {
      ...
      const myRequest = new Request("mavryk://flowers.tez/flowers.jpg", myInit);
    ...
    // Method
    {
      const myRequest = new Request("mavryk://flowers.tez/flowers.jpg");
    ...
    // Url
    {
      ...
      console.log(
        `Actual: ${myURL}, Expected: mavryk://flowers.tez/flowers.jpg`,
      );
    }
    ...
    // Text
    {
      ...
      const request = new Request("mavryk://alistair.tez/myEndpoint", {
        method: "POST",
        body: text,
      });
